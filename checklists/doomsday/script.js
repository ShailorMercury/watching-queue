const ITEMS = [
  { title: "Capitán América: El Primer Vengador", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🕰️ Fase I — El Nacimiento", durationMin: 124, synopsis: "Steve Rogers se convierte en Capitán América durante la Segunda Guerra Mundial. Presenta el Teseracto y establece el origen de Steve, Bucky y una pieza cósmica que volverá a ser fundamental.", why: "Origen de Steve Rogers, Bucky y el Teseracto; conecta directamente con Endgame y el regreso de personajes clásicos en Doomsday." },
  { title: "Agent Carter, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 8, phase: "🕰️ Fase I — El Nacimiento", durationMin: 360, synopsis: "Peggy investiga una conspiración tecnológica mientras demuestra que puede actuar como agente por derecho propio.", why: "Peggy investiga una conspiración tecnológica; profundiza en ella, Howard Stark y el origen de piezas del MCU televisivo." },
  { title: "Agent Carter, temporada 2", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 10, phase: "🕰️ Fase I — El Nacimiento", durationMin: 450, synopsis: "Peggy se traslada a Los Ángeles para investigar una amenaza científica ligada a una misteriosa materia.", why: "Peggy se traslada a Los Ángeles tras una amenaza científica; cierra su arco televisivo y amplía la historia temprana del universo." },
  { title: "X-Men: Primera Generación", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 132, synopsis: "Charles Xavier y Erik Lehnsherr se conocen y forman el primer grupo de mutantes moderno.", why: "Xavier y Magneto se conocen y forman el primer grupo mutante; presenta a las versiones jóvenes que Marvel recupera." },
  { title: "X-Men Orígenes: Lobezno", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 107, synopsis: "Explora el pasado de Logan, su relación con Victor Creed y el experimento que termina convirtiéndolo en el arma conocida como Weapon X.", why: "Explora el pasado de Logan y el experimento Weapon X; da contexto al Lobezno que vuelve en Deadpool & Wolverine." },
  { title: "X-Men", essential: true, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 104, synopsis: "Logan se une a los X-Men mientras Xavier intenta proteger a los mutantes de una sociedad que los teme.", why: "Logan se une a los X-Men frente a una sociedad que teme a los mutantes; versión clásica de Xavier, Magneto y compañía." },
  { title: "X-Men 2", essential: true, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 134, synopsis: "Los X-Men se enfrentan a una amenaza gubernamental que pone en peligro a todos los mutantes.", why: "Los X-Men enfrentan una amenaza gubernamental; profundiza en la familia mutante del legado multiversal de Fox." },
  { title: "X-Men: La Decisión Final", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 104, synopsis: "Una cura para la mutación divide a los X-Men y enfrenta a los mutantes entre sí.", why: "Una cura para la mutación divide a los X-Men; cierra la primera etapa de la saga clásica." },
  { title: "The Wolverine", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 126, synopsis: "Logan viaja a Japón y se enfrenta a enemigos relacionados con su pasado y con su propia inmortalidad.", why: "Logan viaja a Japón enfrentando su pasado e inmortalidad; prepara el contexto emocional de su etapa posterior." },
  { title: "X-Men: Días del Futuro Pasado", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 131, synopsis: "Los X-Men viajan mentalmente al pasado para impedir un futuro dominado por los Centinelas.", why: "Los X-Men viajan mentalmente al pasado para impedir un futuro dominado por Centinelas; pieza clave del multiverso mutante." },
  { title: "X-Men: Apocalipsis", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 144, synopsis: "Los jóvenes X-Men se enfrentan a Apocalipsis, un mutante ancestral que pretende rehacer el mundo.", why: "Los jóvenes X-Men enfrentan a Apocalipsis; amplía la continuidad mutante tras el cambio de línea temporal." },
  { title: "Dark Phoenix", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase II — Los Mutantes", durationMin: 114, synopsis: "Jean Grey pierde el control de un poder cósmico extraordinario y los X-Men intentan salvarla.", why: "Jean Grey pierde el control de un poder cósmico; cierra la etapa de los X-Men jóvenes de Fox." },
  { title: "Spider-Man", essential: false, type: "movie", universe: "Sony", platform: "HBO Max", phase: "🌌 Fase III — Universos Perdidos", durationMin: 121, synopsis: "Peter Parker obtiene poderes y aprende que ser héroe implica responsabilidad y sacrificios personales.", why: "Peter Parker obtiene poderes y aprende sobre la responsabilidad; establece la variante de Tobey Maguire." },
  { title: "Spider-Man 2", essential: false, type: "movie", universe: "Sony", platform: "HBO Max", phase: "🌌 Fase III — Universos Perdidos", durationMin: 127, synopsis: "Peter intenta equilibrar su vida personal con su identidad como Spider-Man mientras se enfrenta al Doctor Octopus.", why: "Peter equilibra su vida y su identidad frente al Doctor Octopus; una de las historias más importantes de la variante Raimi." },
  { title: "Spider-Man 3", essential: false, type: "movie", universe: "Sony", platform: "HBO Max", phase: "🌌 Fase III — Universos Perdidos", durationMin: 139, synopsis: "Peter se enfrenta a Venom, Sandman y a sus propios impulsos mientras su vida se desmorona.", why: "Peter se enfrenta a Venom y Sandman; completa la trilogía Raimi que reaparece en No Way Home." },
  { title: "The Amazing Spider-Man", essential: false, type: "movie", universe: "Sony", platform: "HBO Max", phase: "🌌 Fase III — Universos Perdidos", durationMin: 136, synopsis: "Peter Parker descubre la verdad sobre sus padres y se convierte en Spider-Man en una nueva continuidad.", why: "Peter descubre la verdad sobre sus padres en una nueva continuidad; introduce la variante de Andrew Garfield." },
  { title: "The Amazing Spider-Man 2", essential: false, type: "movie", universe: "Sony", platform: "HBO Max", phase: "🌌 Fase III — Universos Perdidos", durationMin: 141, synopsis: "Peter intenta proteger a Gwen mientras se enfrenta a Electro y otros enemigos.", why: "Peter protege a Gwen frente a Electro; completa el arco de esta versión antes de su regreso multiversal." },
  { title: "Spider-Man: Into the Spider-Verse", essential: false, type: "movie", universe: "Sony", platform: "Netflix", phase: "🌌 Fase III — Universos Perdidos", durationMin: 117, synopsis: "Miles Morales descubre que existen múltiples Spider-Man y que distintas realidades pueden cruzarse.", why: "Miles Morales descubre que existen múltiples Spider-Man; introducción perfecta al concepto de variantes." },
  { title: "Spider-Man: Across the Spider-Verse", essential: false, type: "movie", universe: "Sony", platform: "Netflix", phase: "🌌 Fase III — Universos Perdidos", durationMin: 140, synopsis: "Miles descubre una red de Spider-People conectados entre universos y una amenaza para las propias realidades.", why: "Miles descubre una red de Spider-People y una amenaza multiversal; profundiza en variantes y canon." },
  { title: "X-Men '97, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 10, phase: "🌌 Fase III — Universos Perdidos", durationMin: 270, synopsis: "Los X-Men continúan su vida tras la serie animada clásica y afrontan nuevas amenazas como equipo.", why: "Los X-Men continúan tras la serie clásica; expande el legado animado y la idea de continuidades mutantes." },
  { title: "X-Men '97, temporada 2", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 9, phase: "🌌 Fase III — Universos Perdidos", durationMin: 270, synopsis: "Los X-Men siguen enfrentándose a amenazas cada vez mayores mientras evoluciona su mundo.", why: "Los X-Men afrontan amenazas mayores; continúa esa realidad animada y su relevancia multiversal." },
  { title: "Iron Man", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🦸 Fase IV — El Nacimiento de los Vengadores", durationMin: 126, synopsis: "Tony Stark construye su primera armadura y se convierte en Iron Man.", why: "Tony Stark construye su primera armadura; nacimiento del MCU moderno." },
  { title: "The Incredible Hulk", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "🦸 Fase IV — El Nacimiento de los Vengadores", durationMin: 112, synopsis: "Bruce Banner intenta controlar a Hulk mientras es perseguido por fuerzas militares.", why: "Bruce Banner intenta controlar a Hulk perseguido por el ejército; completa el grupo inicial de héroes del MCU." },
  { title: "Iron Man 2", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "🦸 Fase IV — El Nacimiento de los Vengadores", durationMin: 124, synopsis: "Tony intenta proteger su tecnología mientras aparecen nuevos enemigos y Natasha Romanoff.", why: "Tony protege su tecnología frente a nuevos enemigos; presenta a Black Widow y prepara a los Vengadores." },
  { title: "Thor", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🦸 Fase IV — El Nacimiento de los Vengadores", durationMin: 115, synopsis: "Thor es desterrado a la Tierra y aprende humildad antes de recuperar su poder.", why: "Thor es desterrado a la Tierra y aprende humildad; presenta a Loki y la mitología asgardiana." },
  { title: "Los Vengadores", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🦸 Fase IV — El Nacimiento de los Vengadores", durationMin: 143, synopsis: "Los héroes principales se unen para detener una invasión dirigida por Loki.", why: "Los héroes se unen para detener a Loki; establece el equipo original y el peso de las Gemas del Infinito." },
  { title: "Iron Man 3", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 130, synopsis: "Tony Stark afronta las consecuencias psicológicas de la batalla de Nueva York.", why: "Tony afronta las secuelas psicológicas de Nueva York; profundiza en su evolución como héroe." },
  { title: "Thor: El Mundo Oscuro", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 112, synopsis: "Thor se enfrenta a los Elfos Oscuros y a una amenaza relacionada con el Éter.", why: "Thor enfrenta a los Elfos Oscuros por el Éter; introduce una Gema del Infinito." },
  { title: "Capitán América: El Soldado de Invierno", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 136, synopsis: "Steve Rogers descubre una conspiración dentro de S.H.I.E.L.D. y se enfrenta al Soldado de Invierno.", why: "Steve descubre una conspiración en S.H.I.E.L.D.; transforma el MCU y profundiza en Steve y Bucky." },
  { title: "Guardianes de la Galaxia", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 122, synopsis: "Un grupo de inadaptados se une para proteger una Gema del Infinito.", why: "Un grupo de inadaptados protege una Gema del Infinito; amplía el MCU al espacio." },
  { title: "Guardianes de la Galaxia Vol. 2", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 137, synopsis: "Los Guardianes descubren secretos sobre el origen de Peter Quill.", why: "Los Guardianes descubren el origen de Peter Quill; desarrolla al grupo antes de Infinity War." },
  { title: "Vengadores: La Era de Ultrón", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 141, synopsis: "Tony y Bruce crean una inteligencia artificial que se vuelve contra la humanidad.", why: "Tony y Bruce crean una IA que se rebela; presenta a Wanda, Visión y más piezas esenciales." },
  { title: "Ant-Man", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 117, synopsis: "Scott Lang se convierte en Ant-Man y descubre el poder del Reino Cuántico.", why: "Scott Lang se convierte en Ant-Man; el Reino Cuántico será crucial más adelante." },
  { title: "Capitán América: Civil War", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 147, synopsis: "Los Vengadores se dividen por un conflicto político y moral.", why: "Los Vengadores se dividen por un conflicto moral; sus consecuencias llegan hasta Endgame." },
  { title: "Black Widow", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 134, synopsis: "Natasha afronta su pasado y se reúne con su antigua familia de espías.", why: "Natasha afronta su pasado con su antigua familia de espías; conecta con personajes que vuelven en la nueva era." },
  { title: "Black Panther", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 134, synopsis: "T'Challa se convierte en rey de Wakanda y defiende su país de Killmonger.", why: "T'Challa se convierte en rey de Wakanda; introduce un lugar y personajes clave del MCU." },
  { title: "Spider-Man: Homecoming", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 133, synopsis: "Peter Parker intenta demostrar que puede ser un héroe mientras equilibra su vida adolescente.", why: "Peter Parker demuestra que puede ser un héroe; establece al Spider-Man de Tom Holland antes del multiverso." },
  { title: "Doctor Strange", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 115, synopsis: "Stephen Strange descubre las artes místicas y aprende a manipular el tiempo y la realidad.", why: "Stephen Strange aprende artes místicas y a manipular el tiempo; será figura clave del multiverso." },
  { title: "Deadpool", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 108, synopsis: "Wade Wilson obtiene poderes y se convierte en Deadpool, rompiendo constantemente la cuarta pared.", why: "Wade Wilson obtiene poderes y rompe la cuarta pared; establece la versión que acaba entrando al MCU." },
  { title: "Deadpool 2", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 119, synopsis: "Deadpool intenta proteger a un joven mutante y se cruza con viajes temporales.", why: "Deadpool protege a un joven mutante y se cruza con viajes temporales; prepara el salto al multiverso." },
  { title: "Thor: Ragnarok", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 130, synopsis: "Thor debe detener el Ragnarok mientras Asgard se enfrenta a su destrucción.", why: "Thor detiene el Ragnarok mientras Asgard se destruye; conecta directamente con Infinity War." },
  { title: "Ant-Man y la Avispa", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 118, synopsis: "Scott Lang explora el Reino Cuántico y conoce mejor sus extrañas propiedades.", why: "Scott explora el Reino Cuántico; pieza fundamental de Endgame." },
  { title: "Vengadores: Infinity War", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 149, synopsis: "Thanos reúne las Gemas del Infinito para completar su plan.", why: "Thanos reúne las Gemas del Infinito; el gran punto de ruptura que prepara Endgame." },
  { title: "Capitana Marvel", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 124, synopsis: "Carol Danvers descubre su pasado y sus poderes mientras se desarrolla una guerra cósmica.", why: "Carol Danvers descubre su pasado en una guerra cósmica; conecta con Nick Fury y la tecnología cósmica." },
  { title: "Vengadores: Endgame", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "💎 Fase V — Infinity", durationMin: 182, synopsis: "Los héroes supervivientes intentan revertir el desastre causado por Thanos.", why: "Los héroes revierten el desastre de Thanos; cierra la Saga del Infinito." },
  { title: "WandaVision, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 9, phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 360, synopsis: "Wanda crea una realidad propia mientras procesa su pérdida.", why: "Wanda crea una realidad propia procesando su pérdida; abre la puerta directa al multiverso." },
  { title: "The Falcon and the Winter Soldier", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 6, phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 300, synopsis: "Sam Wilson decide qué significa portar el escudo del Capitán América.", why: "Sam Wilson decide qué significa portar el escudo; establece al nuevo Capitán América." },
  { title: "Loki, temporada 1", essential: true, type: "show", universe: "MCU", platform: "Disney+", episodes: 6, phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 270, synopsis: "Una variante de Loki es capturada por la TVA y descubre una estructura que controla las líneas temporales.", why: "Una variante de Loki descubre la TVA; pieza clave para entender el multiverso y las variantes." },
  { title: "What If...?, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 9, phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 270, synopsis: "El Watcher observa realidades alternativas donde acontecimientos del MCU suceden de forma diferente.", why: "El Watcher observa realidades alternativas del MCU; demuestra visualmente la existencia de variantes infinitas." },
  { title: "Spider-Man: Far From Home", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 129, synopsis: "Peter intenta volver a la normalidad tras Endgame y se enfrenta a Mysterio.", why: "Peter vuelve a la normalidad tras Endgame frente a Mysterio; prepara No Way Home." },
  { title: "Shang-Chi y la Leyenda de los Diez Anillos", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 132, synopsis: "Shang-Chi descubre el legado de su familia y de los Diez Anillos.", why: "Shang-Chi descubre el legado de su familia y los Diez Anillos; amplía el MCU moderno." },
  { title: "Hawkeye, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 6, phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 300, synopsis: "Clint Barton intenta cerrar cuentas pendientes mientras protege a Kate Bishop.", why: "Clint cierra cuentas pendientes protegiendo a Kate Bishop; desarrolla el legado Hawkeye y el nuevo grupo de héroes." },
  { title: "Spider-Man: No Way Home", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 148, synopsis: "Peter provoca una ruptura del hechizo de Doctor Strange que trae visitantes de otras realidades.", why: "Peter rompe el hechizo de Strange y trae visitantes de otras realidades; reúne las tres generaciones de Spider-Man." },
  { title: "Doctor Strange en el Multiverso de la Locura", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 126, synopsis: "Doctor Strange y America Chavez viajan por diferentes universos mientras Wanda busca poder para recuperar a sus hijos.", why: "Strange y America Chavez viajan entre universos; expande las reglas del multiverso y las incursiones." },
  { title: "Ms. Marvel, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 6, phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 270, synopsis: "Kamala Khan descubre que posee habilidades extraordinarias ligadas a su herencia.", why: "Kamala Khan descubre sus habilidades ligadas a su herencia; conecta después con Carol Danvers." },
  { title: "Thor: Love and Thunder", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 119, synopsis: "Thor se enfrenta a Gorr mientras Jane Foster adopta el manto de Mighty Thor.", why: "Thor enfrenta a Gorr mientras Jane adopta el manto de Mighty Thor; continúa su mitología." },
  { title: "Black Panther: Wakanda Forever", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "🌀 Fase VI — El Despertar del Multiverso", durationMin: 161, synopsis: "Wakanda afronta la pérdida de T'Challa y la amenaza de Namor.", why: "Wakanda afronta la pérdida de T'Challa frente a Namor; establece a Shuri como Black Panther." },
  { title: "Ant-Man y la Avispa: Quantumanía", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "⏳ Fase VII — La Guerra de las Realidades", durationMin: 124, synopsis: "La familia Lang entra en el Reino Cuántico y se enfrenta a Kang.", why: "La familia Lang entra al Reino Cuántico y enfrenta a Kang; introduce la amenaza multiversal de Kang." },
  { title: "Guardianes de la Galaxia Vol. 3", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "⏳ Fase VII — La Guerra de las Realidades", durationMin: 150, synopsis: "Los Guardianes emprenden una misión para salvar a Rocket y cerrar una etapa del grupo.", why: "Los Guardianes salvan a Rocket cerrando una etapa; prepara el reparto cósmico del MCU." },
  { title: "The Marvels", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "⏳ Fase VII — La Guerra de las Realidades", durationMin: 105, synopsis: "Carol Danvers, Kamala Khan y Monica Rambeau quedan conectadas por un fenómeno que intercambia sus posiciones.", why: "Carol, Kamala y Monica quedan conectadas por un fenómeno; deja preparado el futuro de Kamala y los equipos jóvenes." },
  { title: "Loki, temporada 2", essential: true, type: "show", universe: "MCU", platform: "Disney+", episodes: 6, phase: "⏳ Fase VII — La Guerra de las Realidades", durationMin: 300, synopsis: "Loki intenta salvar las líneas temporales mientras la TVA afronta una crisis existencial.", why: "Loki intenta salvar las líneas temporales en crisis; profundiza en la estructura del multiverso." },
  { title: "What If...?, temporada 2", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 9, phase: "⏳ Fase VII — La Guerra de las Realidades", durationMin: 270, synopsis: "El Watcher continúa explorando realidades alternativas del MCU.", why: "El Watcher sigue explorando realidades alternativas; amplía el mapa de variantes." },
  { title: "What If...?, temporada 3", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 8, phase: "⏳ Fase VII — La Guerra de las Realidades", durationMin: 270, synopsis: "Nuevas realidades alternativas muestran diferentes destinos para héroes conocidos.", why: "Nuevas realidades muestran diferentes destinos para héroes conocidos; continúa la exploración del multiverso animado." },
  { title: "Logan", essential: false, type: "movie", universe: "Fox", platform: "Disney+", phase: "🧬 Fase VIII — El Regreso", durationMin: 137, synopsis: "Un Logan envejecido protege a una joven mutante en un futuro oscuro.", why: "Un Logan envejecido protege a una joven mutante en un futuro oscuro; cierre emocional relevante para Deadpool & Wolverine." },
  { title: "Deadpool & Wolverine", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🧬 Fase VIII — El Regreso", durationMin: 128, synopsis: "Deadpool se ve arrastrado a un conflicto multiversal que lo lleva a cruzarse con una variante de Lobezno.", why: "Deadpool se ve arrastrado a un conflicto multiversal con una variante de Lobezno; puente directo entre Fox y el MCU." },
  { title: "Secret Invasion, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 6, phase: "⚡ Fase IX — El Nuevo Mundo", durationMin: 300, synopsis: "Nick Fury intenta detener una infiltración Skrull mientras el mundo pierde confianza en sus defensores.", why: "Nick Fury intenta detener una infiltración Skrull; amplía la situación política del MCU moderno." },
  { title: "Echo, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 5, phase: "⚡ Fase IX — El Nuevo Mundo", durationMin: 240, synopsis: "Maya Lopez vuelve a su pueblo y afronta su pasado mientras se enfrenta a Wilson Fisk.", why: "Maya Lopez afronta su pasado frente a Wilson Fisk; continúa el mundo de Daredevil y Kingpin." },
  { title: "Ironheart, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 6, phase: "⚡ Fase IX — El Nuevo Mundo", durationMin: 300, synopsis: "Riri Williams continúa el legado tecnológico de Tony Stark y se enfrenta a amenazas mágicas y tecnológicas.", why: "Riri Williams continúa el legado tecnológico de Stark frente a amenazas mágicas; introduce una nueva generación de héroes." },
  { title: "Agatha All Along, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 9, phase: "⚡ Fase IX — El Nuevo Mundo", durationMin: 300, synopsis: "Agatha Harkness emprende un viaje por el misterioso Camino de las Brujas.", why: "Agatha Harkness recorre el Camino de las Brujas; expande la magia introducida en WandaVision." },
  { title: "Daredevil: Born Again, temporada 1", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 9, phase: "⚡ Fase IX — El Nuevo Mundo", durationMin: 495, synopsis: "Matt Murdock vuelve a enfrentarse a Wilson Fisk en una batalla por el control de Nueva York.", why: "Matt Murdock vuelve a enfrentarse a Fisk; integra definitivamente a Daredevil y Kingpin en el MCU moderno." },
  { title: "Capitán América: Brave New World", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "⚡ Fase IX — El Nuevo Mundo", durationMin: 118, synopsis: "Sam Wilson, ya como Capitán América, se enfrenta a una crisis internacional y a nuevas amenazas.", why: "Sam Wilson, como Capitán América, enfrenta una crisis internacional; consolida al nuevo Capitán y el tablero político." },
  { title: "Thunderbolts*", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "⚡ Fase IX — El Nuevo Mundo", durationMin: 127, synopsis: "Un grupo de antihéroes y personajes problemáticos se ve obligado a trabajar unido.", why: "Un grupo de antihéroes se ve obligado a trabajar unido; establece a los New Avengers, pieza clave antes de Doomsday." },
  { title: "Daredevil: Born Again, temporada 2", essential: false, type: "show", universe: "MCU", platform: "Disney+", episodes: 8, phase: "🔮 Fase X — El Último Tablero", durationMin: 360, synopsis: "Matt Murdock continúa su lucha contra el poder de Wilson Fisk y las amenazas de Nueva York.", why: "Matt continúa su lucha contra Fisk; sigue el lado urbano del MCU antes de la gran convergencia." },
  { title: "The Punisher: One Last Kill", essential: false, type: "movie", universe: "MCU", platform: "Disney+", phase: "🔮 Fase X — El Último Tablero", durationMin: 60, synopsis: "Frank Castle regresa para afrontar una última misión.", why: "Frank Castle regresa para una última misión; continúa su legado en el universo televisivo integrado." },
  { title: "Spider-Man: Brand New Day", essential: false, type: "movie", universe: "MCU", platform: "Cines", phase: "🔮 Fase X — El Último Tablero", durationMin: 130, synopsis: "Peter Parker afronta una nueva etapa después de los acontecimientos multiversales que cambiaron su vida.", why: "Peter afronta una nueva etapa tras los sucesos multiversales; escena post-créditos con peso directo para Doomsday." },
  { title: "VisionQuest", essential: false, type: "show", universe: "MCU", platform: "Disney+ (14 oct 2026)", episodes: 8, phase: "🔮 Fase X — El Último Tablero", durationMin: 360, synopsis: "La historia de Vision continúa después de los acontecimientos de WandaVision.", why: "La historia de Visión continúa tras WandaVision; profundiza en él y en la identidad artificial justo antes del estreno." },
  { title: "The Fantastic Four: First Steps", essential: true, type: "movie", universe: "MCU", platform: "Disney+", phase: "🔮 Fase X — El Último Tablero", durationMin: 130, synopsis: "Reed Richards, Sue Storm, Johnny Storm y Ben Grimm forman una familia de héroes en una realidad con estética retrofuturista.", why: "Reed, Sue, Johnny y Ben forman su familia de héroes; introduce a Reed Richards, pieza clave ante Doctor Doom." },
  { title: "Avengers: Doomsday", essential: true, type: "movie", universe: "MCU", platform: "Cines · 18 dic 2026", phase: "💀 Fase XI — Doomsday", durationMin: 150, synopsis: "La gran convergencia de héroes y personajes procedentes de distintas realidades.", why: "🎯 La gran convergencia: Vengadores, mutantes, 4 Fantásticos y variantes multiversales frente a Doctor Doom.", event: true }
];
...
const ROUTE_STORAGE_KEY = "doomsday-route-v2";
...
let currentRoute = "completa"; // "completa" | "esencial"

// true si el título en ese índice entra dentro de la ruta activa — el
// progreso (state/watchedDates/etc.) es siempre el mismo dato de fondo,
// esto solo decide qué se muestra y qué cuenta en cada momento
function isInRoute(i) {
  return currentRoute === "completa" || !!ITEMS[i].essential;
}
...
function render() {
  ...
  ITEMS.forEach((item, i) => {
    if (!isInRoute(i)) return; // fuera de la ruta activa: no aparece en ningún listado
  ...
  const routeTotal = ITEMS.reduce((acc, _, i) => acc + (isInRoute(i) ? 1 : 0), 0);
  const openTotal = routeTotal - doneTotal - archivedTotal;
...
function updateProgress() {
  const activeIndices = ITEMS.map((_, i) => i).filter(i => !archived[i] && isInRoute(i));
...
function renderProgressChart() {
  ...
  const movieDates = Object.entries(watchedDates)
    .filter(([idx]) => !ITEMS[idx].episodes && isInRoute(idx))
    .map(([, iso]) => new Date(iso));
  const episodeDates = Object.entries(episodeWatchedDates)
    .filter(([key]) => isInRoute(parseInt(key.split("_")[0], 10)))
    .map(([, iso]) => new Date(iso));
...
function updateDashboard(done, total) {
  ...
  const totalMin = ITEMS.reduce((acc, it, i) => (archived[i] || !isInRoute(i)) ? acc : acc + (it.durationMin || 0), 0);
  ...
  // dentro de la ruta activa) — se muestra en la tarjeta de "Próximo expediente".
  // en las series con capítulos, se reparte la duración total entre los capítulos
  // y solo cuenta como pendiente los que faltan por ver, para que baje según vas
  // marcando capítulos sueltos y no solo al completar la temporada entera
  const pendingMin = ITEMS.reduce((acc, it, i) => {
    if (archived[i] || !isInRoute(i)) return acc;
    if (it.episodes) {
  ...
  const archivedCount = ITEMS.reduce((acc, _, i) => acc + (archived[i] && isInRoute(i) ? 1 : 0), 0);
  renderStatusDonut(done, total - done, archivedCount);

  const movies = ITEMS.filter((it, i) => it.type === "movie" && !archived[i] && isInRoute(i));
  const shows = ITEMS.filter((it, i) => it.type === "show" && !archived[i] && isInRoute(i));
  const moviesDone = ITEMS.reduce((acc, it, i) => acc + (it.type === "movie" && !archived[i] && isInRoute(i) && state[i] ? 1 : 0), 0);
  const showsDone = ITEMS.reduce((acc, it, i) => acc + (it.type === "show" && !archived[i] && isInRoute(i) && state[i] ? 1 : 0), 0);
  ...
  const nextIdx = ITEMS.findIndex((_, i) => !state[i] && !archived[i] && isInRoute(i));
...
function renderPhaseTracker(nextIdx) {
  ...
  const phaseItems = ITEMS.filter((it, i) => it.phase === currentPhase && !archived[i] && isInRoute(i));
  const phaseDone = ITEMS.reduce((acc, it, i) => acc + (it.phase === currentPhase && !archived[i] && isInRoute(i) && state[i] ? 1 : 0), 0);
...
function setRoute(route) {
  currentRoute = route;
  try { localStorage.setItem(ROUTE_STORAGE_KEY, currentRoute); } catch (err) {}
  document.getElementById("routeBtnCompleta").classList.toggle("active", route === "completa");
  document.getElementById("routeBtnEsencial").classList.toggle("active", route === "esencial");
  render(); // recalcula listas/contadores/gráfica/dashboard/fase con el nuevo alcance
  renderCatalogStats(); // los donuts del catálogo no se recalculan dentro de render()
}

document.getElementById("routeBtnCompleta").addEventListener("click", () => setRoute("completa"));
document.getElementById("routeBtnEsencial").addEventListener("click", () => setRoute("esencial"));
...
function loadState() {
  try {
    ...
    const rawRoute = localStorage.getItem(ROUTE_STORAGE_KEY);
    if (rawRoute === "completa" || rawRoute === "esencial") currentRoute = rawRoute;
  } catch (e) {
    state = {};
    episodeState = {};
    watchedDates = {};
  ...
  document.getElementById("routeCountCompleta").textContent = ITEMS.length;
  document.getElementById("routeCountEsencial").textContent = ITEMS.filter(it => it.essential).length;
  document.getElementById("routeBtnCompleta").classList.toggle("active", currentRoute === "completa");
  document.getElementById("routeBtnEsencial").classList.toggle("active", currentRoute === "esencial");
